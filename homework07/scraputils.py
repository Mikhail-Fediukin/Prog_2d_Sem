...
def extract_news(parser):  # извлекает новости с веб-страницы, используя парсер.
    ...
    list_of_news = []  # пустой список, в который будут добавляться новости.
    ...
    for i in range(len(news) - 1):
        ...
        if news_.attrs:  # Если у текущей строки есть атрибуты, то это означает, что она содержит заголовок новости.
